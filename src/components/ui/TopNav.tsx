...
export const TopNav: React.FC<TopNavProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 px-6 sm:px-12 md:px-16 py-4 sm:py-5 flex items-center justify-between pointer-events-none backdrop-blur-md bg-black/40 border-b border-white/5 transition-all duration-300">
